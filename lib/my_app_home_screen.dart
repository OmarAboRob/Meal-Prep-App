...
class _MyAppHomeScreenState extends State<MyAppHomeScreen> {
 ...
 Query get fileteredRecipes => FirebaseFirestore.instance.collection("favorites").where('category',isEqualTo: category,);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: StreamBuilder(stream: categoriesItems.snapshots(),
                  builder:
                  (context,
                            ...
                            (index)=>GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  ["name"]?const Color(0xff568A9F):Colors.white,
                                ...
                                style: TextStyle(fontWeight: FontWeight.w600,
                                  color: category==streamSnapshot.data!.docs[index]
                                  ["name"]?Colors.white:Colors.grey.shade600,),
                                ),
                              ),
                            )
                        ),
              ...
              StreamBuilder(stream: selectedRecipes.snapshots(),
                builder:
                    (context,
                    AsyncSnapshot<QuerySnapshot> snapshot){
                  if(snapshot.hasData){
                    final List<DocumentSnapshot> recipes = snapshot.data?.docs??[];
                    return Padding(padding: EdgeInsets.only(top: 5,left: 15),
                      child: SingleChildScrollView(
                        scrollDirection: Axis.horizontal,
                        child: Row(
                          children: recipes.map((e) => FoodItemsDisplay(documentSnapshot: e)).toList(),
